...
const movies = [
  {
    id: 1,
    title: 'Movie Title 1',
    imageUrl: 'https://via.placeholder.com/300x450', // Replace with actual movie image URL
...
const moviesList = () => {
  return (
    <div class="bg-white">
      {movies.map((movie) => (
        <div key={index} class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
