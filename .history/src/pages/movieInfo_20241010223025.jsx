    ...
    return (
            <div className="movie-info-container">
                ...
                <div>
                    ...
                    <p className="description">Ashitaka finds himself in the middle of a war between the forest gods and Tatara, a mining colony. </p>
                    <p className="description">In this quest he also meets San, the Mononoke Hime.</p>
                </div>
            </div>
    )
}