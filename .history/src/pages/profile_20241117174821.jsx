  ...
  {/* static profile circle */}
        <Box className='profile-pic'
         ...
         margin="1rem"
              />
        <Box ml={4}>
          <Heading as="h2" fontSize="26px" marginBottom=".1rem" marginTop="2.5rem">Digi Girl🍿</Heading> {/* Replace with actual user name */}
...
<Box>
<Text as="h4" fontSize="22px" marginTop="0.6" fontWeight="300">
Animated movie enthusiast, always on the lookout for the next favorite to add to my collection.
     ...
     {/* visited Carousel */}
     <Box>
        <Heading as="h2" size="xl" textAlign="center" mt={0} mb={20}>
        Visiting History
        </Heading>
