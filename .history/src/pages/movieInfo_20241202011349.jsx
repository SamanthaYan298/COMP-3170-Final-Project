            ...
            <div className="movie-info-container">
                <div className="back-btn">
                    <Link to="/movies" className='movie-page'>
                        <svg onClick={handlePopupToggle} width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <div>
                        ...
                        2h 13m</p>
                        <a href="https://www.imdb.com/title/tt0119698/?ref_=nv_sr_srsg_0_tt_7_nm_1_in_0_q_%2520princess%2520momon" target="_blank" rel="noopener noreferrer">
