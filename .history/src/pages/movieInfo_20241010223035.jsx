    ...
    return (
            <div className="movie-info-container">
                ...
                <div>
                    ...
                    <div class="line"></div>
                    <p className="description">On a journey to find the cure for a Tatarigami's curse, </p>
                    <p className="description-2">Ashitaka finds himself in the middle of a war between the forest gods and Tatara, a mining colony. </p>
                    <p className="description-3">In this quest he also meets San, the Mononoke Hime.</p>
                </div>
            </div>
    )
}