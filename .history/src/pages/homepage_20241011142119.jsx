...
import MovieCarousel from '../components/MovieCarousel'; // Import the new MovieCarousel component
  ...
  return (
    <Box>
      ...
      <Box>
        ...
        <MovieCarousel movies={trendingMovies} /> {/* Use the MovieCarousel component */}
      </Box>
      ...
      <Box mt={10} mb={6}>
        ...
        <MovieCarousel movies={trendingMovies} /> {/* Optionally, you can add another carousel here */}
      </Box>
    </Box>
  );
};
