...
const DropdownFilter = ({ onChange }) => {
    return (
      ...
      >
        ...
        <option value="Pixar Animation Studios" title="Pixar Animation Studios"  className='studios'>Pixar Animation</option>
        <option value="Walt Disney Animation Studios" title="Walt Disney Animation Studios"  className='studios'>Disney Studios</option>
        </optgroup>
