...
const BottomNavigation = () => {
  return (
    <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[430px] bg-gradient-to-t from-teal-500 to-blue-500 text-white shadow-lg z-50">
      <div className="flex justify-around items-center h-16" style={{
        background: 'rgba(221, 184, 255, 0.8), rgba(214, 239, 255, 0.5)', 
