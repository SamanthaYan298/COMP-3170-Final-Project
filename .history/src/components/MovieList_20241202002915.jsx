...
const MovieList = ({ filter }) => {
  ...
  return (
    <Box>
      ...
      <Flex align="center" mb={4}>  {/* Flex container for horizontal layout */}
        <Button onClick={() => setSortOrder('asc')} mr={4}>⬆️</Button>
        <Button onClick={() => setSortOrder('desc')} mr={4}>⬇️</Button>
        <DropdownFilter onChange={(e) => filter(e.target.value)} />  {/* DropdownFilter component */}
      </Flex>
