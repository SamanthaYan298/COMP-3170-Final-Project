...
const BottomNavigation = () => {
  return (
    <div className="fixed bottom-0 left-0 w-center bg-gradient-to-t from-teal-500 to-blue-500 text-white shadow-lg z-50">
      <div className="flex justify-around items-center h-16 mx-auto max-w-4xl">
        {/* Home Button */}
